<template>
  <div 
    class="cozy-date-picker"
    ref="pickerRef"
  >
    <div 
      class="cozy-date-picker-input"
      @click="togglePanel"
    >
      <input
        ref="inputRef"
    ...
    <div 
      v-show="panelVisible"
      class="cozy-date-picker-panel"
    >
      <!-- 面板头部 -->
      <div class="cozy-date-picker-header">
        <button 
          class="cozy-date-picker-prev-btn"
          @click="prevMonth"
        >
        ...
        <button 
          class="cozy-date-picker-next-btn"
          @click="nextMonth"
        >
